...
class Recommender:
    ...
    def user_ratings(self, user_id, n):
        ...
        ratings = [(self.convert_product_id_to_name(k), v)
                   for (k, v) in ratings]
    ...
    def slope_one_recommendations(self, userratings):
        recommendations = {}
        frequencies = {}
        ...
        recommendations = [(self.convert_product_id_to_name(k),
                            v / frequencies[k])
